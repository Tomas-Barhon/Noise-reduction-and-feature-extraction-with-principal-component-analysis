...
philosophy between the \ac{BTC} and \ac{ETH} philosophy from their respective 
whitepapers. \ac{ETH} is much 
more focused on its role as an application platform whereas \ac{BTC} was mainly 
intended to work as a currency. The \ac{ETH} whitepaper especially
...
post by the founder of \ac{LTC} Charlie Lee where he suggests reading 
...
in pools and thus more centralized distribution of \ac{BTC}.
