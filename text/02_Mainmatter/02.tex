...
and the dynamic nature of the search engine changin with years of development.
...
search terms are useful in predicting for predicting stock market movement
and as a proxy variable for investor attention. Most notably they emphasize 
that the changes are conditional on the sentiment of the search. Suggesting
...
the the price over or underperformed compared to a moving average of 4 days
for  Google Trends and 7 days for Wikipedia visits. 
